<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Menu untuk Admin dan Staff (Kelola Barang & Transaksi) -->
                    ...
                    <!-- Menu untuk Admin dan Manager (Melihat Laporan) -->
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <button id="theme-toggle" type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 me-2 transition">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                ...
                <button id="theme-toggle-mobile" type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 me-2 transition">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- Menu Mobile untuk Admin dan Staff -->
            @if(in_array(Auth::user()->role->name, ['Admin', 'Staff']))
            ...
            <!-- Menu Mobile untuk Admin dan Manager -->
            @if(in_array(Auth::user()->role->name, ['Admin', 'Manager']))
